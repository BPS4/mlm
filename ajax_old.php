...
if ($action == "get_sponsor") {
    ...
    if (isset($_POST['user_id']) && isset($_POST['withdrawal_amount'])) {
        ...
        $query_insert = "INSERT INTO `withdrawal`(`user_id`, `withdrawal_amount`, `create_date`) VALUES ('$user_id', '$withdrawal_amount', '$current_date')";
        if (mysqli_query($conn,$query_insert)) {
            ...
            $query_update_user_withdrawal = "UPDATE `wallets` SET `superwallet`=`superwallet`-'$withdrawal_amount', `update_date`='$current_date' WHERE `user_id`='$user_id'";
            mysqli_query($conn,$query_update_user_withdrawal);
