...
<?php
    ...
    $header = "Total Available Wallet of all users";
	...
	// LENGTH MENU
        ...
        // $sql = "SELECT transaction_amount, create_date 
        // FROM wallet_transaction 
        // WHERE user_id = 695202 
        //   AND transaction_type IN ('level_commission', 'sponsor_commission')";
											...
											<table id="datatables" class="table table-striped" style="width:100%">
												...
												<thead>
													<tr>
														...
														<th class="text-center">wallet_investment</th>
														<th class="text-center">wallet_roi</th>
														<th class="text-center">wallet_commission</th>
													...
													foreach ($transactions as $row) {
														...
														//CHECK DATE FOR YYYY-MM-DD OR YYYY-MM-DD hh:ii:ss FORMAT
															...
															if (preg_match($regEx, $update_date) || preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/", $update_date)) {
																...
																$update_date = date_format($update_date, "d M Y h:ia");
															}
														//CHECK DATE FOR YYYY-MM-DD OR YYYY-MM-DD hh:ii:ss FORMAT
														...
														?>
															...
															<tr>
                                                                ...
                                                                <td class="text-center"><?php echo $wallet_investment; ?></td>
                                                                <td class="text-center"><?php echo $wallet_roi; ?></td>
                                                                <td class="text-center"><?php echo $wallet_commission; ?></td>
