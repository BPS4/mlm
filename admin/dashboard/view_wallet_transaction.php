...
<?php
	...
	// CHECK AVAILABILITY
		if (isset($_GET['type'])) {
			...
			if ($type == "credit") {
				$type_caps = "Member Superwallet Withdrawal";
            } else if ($type == "admin_roi") {
				$type_caps = "Admin ROI Wallet Summary";
            } else if ($type == "admin_commission") {
				$type_caps = "Admin Commission Wallet Summary";
            }

			$header = "$type_caps";
			$check_type = " `from_wallet` IN ('wallet_roi','wallet_commission','wallet_investment') AND `transaction_mode`='credit' ";
		} else {
			$header = "Superwallet Transfer to Other Members";
			$check_type = " `from_wallet` IN ('superwallet_transfer') AND `transaction_mode`='credit' ";
		}
	// CHECK AVAILABILITY
	...
	// GET ALL TRANSACTION
		// FOR SELECT QUERIES
			$query_transaction = "SELECT * FROM `transaction_superwallet` WHERE $check_type ORDER BY `create_date` DESC";
...
?>
	...
	<head>
		...
		<link rel="canonical" href="view_wallet_transaction.php">
													...
													<tr>
                                                        ...
                                                        <?php
                                                            if ($type == "credit") {
                                                                ...
                                                                ?>
                                                                    <th style="white-space: nowrap;">Donor ID</th>
                                                                    <th style="white-space: nowrap;">Donor</th>
                                                                    <th style="white-space: nowrap;">Receiver ID</th>
                                                                    <th style="white-space: nowrap;">Receiver</th>
                                                                <?php
                                                            }
                                                        ?>
													...
													foreach ($records as $row) {
														...
														// DATA
                                                            ...
                                                            if ($type == "credit") {
                                                                ...
                                                                $from_user_id = $user_id_member;                                                            
                                                                // $donor = $user_id_member = "SELF";
                                                            } else {
                                                                $donor = get_user_name($from_user_id);
                                                                $receiver = get_user_name($user_id_member);
														...
														?>
															...
															<tr>
                                                                ...
                                                                ?>
																<td class="has-html text-center"><span class="badge bg-<?php echo $class_txn; ?>" style="white-space: normal;"><?php echo $transaction_amount; ?></span></td>
