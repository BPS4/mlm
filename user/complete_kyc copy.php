...
<?php
    ...
    $position = 4;
    $header_text = "Complete KYC For $name ($user_id)";
    ...
    $aadhaar_readonly = $pan_readonly = $bank_readonly = $cheque_readonly = $passbook_readonly = $photo_readonly = "";
...
<body>
                                                            ...
                                                            if ($bank_needed == 1) {
                                                                ?>
                                                                    <div class="mb-3 col-xl-6 col-md-8">
                                                                        ...
                                                                        <input type="file" name="file_bank" id="file_bank_proof" class="form-control" accept="image/*" required onchange="check_image_size_before_upload(this.id,500);">
                                                                    </div>
                                                                <?php
                                                            } else {
                                                                ?>
    ...
    <script>
        ...
        var btn_submit = document.getElementById("btn_submit_document")
