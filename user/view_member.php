...
<?php
    ...
    $position = 4;
    $header_text = "Referral Summary For $name ($user_id)";
    ...
    // GET DATA
        $query = "SELECT `sponsor_id`, `user_id`, `user_rank`, `name`, `mobile`, `email`, `aadhaar`, `aadhaar_file`, `pan`, `pan_file`, `bank_name`, `branch_name`, `account_no`, `ifs_code`, `upi_handle`, `address`, `city`, `state`, `pin_code`, `fund_wallet`, `fund_commission`, `fund_total`, `status`, `is_bank_updated`, `level1_member`, `level2_member`, `level3_member`, `level4_member`, `level5_member`, `create_date`, `active_date` FROM `users` WHERE `sponsor_id`='$user_id' ORDER BY `create_date` DESC";
