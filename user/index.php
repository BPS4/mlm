...
$total_income = $res['total_amount'];
    ...
    $query = "SELECT SUM(withdrawal_amount) AS total_withdrawal_amount FROM `withdrawal` WHERE `user_id`='$user_id' AND `status`='approved'";
$res = mysqli_query($conn, $query);
$row = mysqli_fetch_assoc($res);
$total_withdrawal_amount = $row['total_withdrawal_amount'];


$query = "SELECT SUM(tds) AS total_tds FROM `withdrawal` WHERE `user_id`='$user_id' AND create_date >= '2024-03-01'";
$res = mysqli_query($conn, $query);
$row = mysqli_fetch_assoc($res);
                ...
                <div class="container-fluid default-dash">
                    <div class="row"> 
                        ...
                        <div class="col-xl-6 col-md-6 dash-xl-50">
                            <div class="ribbon-wrapper card shadow">
                                <div class="card-body">
                                    <div class="ribbon ribbon-clip-right ribbon-right ribbon-dark shadow text-bold">Team Size</div>
                                    <div class="media static-widget mb-3">
                                        <div class="media-body">
                        ...
                        <div class="col-xl-6 col-md-6 dash-xl-50">
                                <div class="ribbon-wrapper card shadow">
                                    <div class="card-body">
                                        <div class="ribbon ribbon-clip ribbon-secondary shadow text-bold">Withdrawal</div>
                                        <div class="media static-widget mb-3">
                                            <div class="media-body">
                            ...
                            <div class="col-xl-6 col-md-6 dash-xl-50">
                                <div class="ribbon-wrapper-right card shadow">
                                    <div class="card-body">
                                        <div class="ribbon ribbon-clip-right ribbon-right ribbon-success shadow text-bold">TDS</div>
                                        <div class="media static-widget mb-3">
                                            <div class="media-body">
