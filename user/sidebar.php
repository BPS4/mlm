            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list">
                        ...
                        <li class="sidebar-list">
                            <a class="sidebar-link sidebar-title link-nav" href="welcomeletter.php">
                    ...
                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav" href="team_member.php">
                            <i data-feather="users"></i>
                    ...
                    <li class="sidebar-list">
                        ...
                        <a class="sidebar-link sidebar-title link-nav" href="<?php echo 'download.php?f=PresentationMaxizone.pdf'; ?>" target="_blank" title="Download Maxizone User Manual">   
                            <i data-feather="download"></i>
                            <span>Presentation - Maxizone</span>
                        </a>
                    </li>
                    ...
                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav" href="tds-history.php">
                            <i class="icofont icofont-money"></i>
