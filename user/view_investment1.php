...
<?php
    ...
    // GET USER DATA
        $query = "SELECT `sponsor_id`, `user_id`, `name`, `mobile`, `email`, `status` AS 'user_status', `create_date` FROM `users` WHERE `user_id`='$user_id'";
                                                        ...
                                                        <?php
                                                            ...
                                                            foreach ($transactions as $item) {
                                                                ...
                                                                switch ($status) {
                                                                    ...
                                                                    // case 'approved':
                                                                    case '1':
                                                                        $transaction_status = "<span class='badge bg-success shadow rounded'>APPROVED</span>";
                                                                        break;
