...
<html lang="en">
<?php
echo "Something is Cooking 🍽️🍴. Please Check Later. <a href='./'>GO TO HOME</a>";
exit;
?>
  <head>
    ...
    <link href="assets/css/custom/css2-2?family=Rubik:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&amp;display=swap" rel="stylesheet">
    <link href="assets/css/custom/css2-3?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&amp;display=swap" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="assets/css/vendors/font-awesome-1.css">
    <!-- ico-font-->
    <link rel="stylesheet" type="text/css" href="assets/css/vendors/icofont-1.css">
    <!-- Themify icon-->
    <link rel="stylesheet" type="text/css" href="assets/css/vendors/themify-1.css">
    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="assets/css/vendors/flag-icon-1.css">
    <!-- Feather icon-->
    <link rel="stylesheet" type="text/css" href="assets/css/vendors/feather-icon-1.css">
    <!-- Plugins css start-->
    <link rel="stylesheet" type="text/css" href="assets/css/vendors/scrollbar-1.css">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
    <link rel="stylesheet" type="text/css" href="assets/css/vendors/bootstrap-1.css">
    <!-- App css-->
    <link rel="stylesheet" type="text/css" href="assets/css/style-1.css">
    <link id="color" rel="stylesheet" href="assets/css/color-1-1.css" media="screen">
    <!-- Responsive css-->
  ...
  <body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-header">
        <div class="header-wrapper row m-0"> 
          <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index-1.html"><img class="img-fluid" src="assets/images/logo/logo-1.png" alt=""></a></div>
      ...
      <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper"> 
          <div>
            <div class="logo-wrapper"><a href="index-1.html"><img class="img-fluid for-light" src="assets/images/logo/small-logo-1.png" alt=""><img class="img-fluid for-dark" src="assets/images/logo/small-white-logo-1.png" alt=""></a>
              <div class="back-btn"><i class="fa fa-angle-left"></i></div>
            </div>
            <div class="logo-icon-wrapper"><a href="index-1.html"><img class="img-fluid" src="assets/images/logo-icon-1.png" alt=""></a></div>
            <nav class="sidebar-main">
              <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  <li class="back-btn"><a href="index-1.html"><img class="img-fluid" src="assets/images/logo-icon-1.png" alt=""></a>
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a class="lan-4" href="index-1.html">Default</a></li>
                      <li><a class="lan-5" href="dashboard-02-1.html">E-commerce</a></li>
                      <li><a href="crypto-dashboard-1.html">Crypto</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="general-widget-1.html">General</a></li>
                      <li><a href="chart-widget-1.html">Chart</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="box-layout-1.html">Boxed</a></li>
                      <li><a href="layout-rtl-1.html">RTL</a></li>
                      <li><a href="layout-dark-1.html">Dark Layout</a></li>
                      <li><a href="hide-on-scroll-1.html">Hide Nav Scroll</a></li>
                      <li><a href="footer-light-1.html">Footer Light</a></li>
                      <li><a href="footer-dark-1.html">Footer Dark</a></li>
                      <li><a href="footer-fixed-1.html">Footer Fixed</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="projects-1.html">Project List</a></li>
                      <li><a href="projectcreate-1.html">Create new</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="file-manager-1.html">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g>
                  ...
                  <li class="sidebar-list">  
                    <label class="badge badge-light-danger">Latest             </label><a class="sidebar-link sidebar-title link-nav" href="kanban-1.html">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    ...
                    <ul class="sidebar-submenu">
                      ...
                      <li><a href="product-page-1.html">Product page</a></li>
                      <li><a href="list-products-1.html">Product list</a></li>
                      <li><a href="payment-details-1.html">Payment Details</a></li>
                      <li><a href="order-history-1.html">Order History</a></li>
                      <li><a href="invoice-template-1.html">Invoice</a></li>
                      <li><a href="cart-1.html">Cart</a></li>
                      <li><a href="list-wish-1.html">Wishlist</a></li>
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="email_inbox-1.html">Email App</a></li>
                      <li><a href="email_read-1.html">Read mail</a></li>
                      <li><a href="email_compose-1.html">Email Compose</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="chat-1.html">Chat App</a></li>
                      <li><a href="chat-video-1.html">Video chat</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="user-profile-1.html">Users Profile</a></li>
                      <li><a href="edit-profile-1.html">Users Edit</a></li>
                      <li><a href="user-cards-1.html">Users Cards</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="bookmark-1.html">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
                            <path d="M8.54248 9.21777H15.3975" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="contacts-1.html">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="task-1.html">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="calendar-basic-1.html">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="social-app-1.html">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="to-do-1.html">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="search-1.html">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M11.2753 2.71436C16.0029 2.71436 19.8363 6.54674 19.8363 11.2753C19.8363 16.0039 16.0029 19.8363 11.2753 19.8363C6.54674 19.8363 2.71436 16.0039 2.71436 11.2753C2.71436 6.54674 6.54674 2.71436 11.2753 2.71436Z" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                    ...
                    <ul class="sidebar-submenu">
                      <li><a class="submenu-title" href="#">Form Controls<span class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                        <ul class="nav-sub-childmenu submenu-content">
                          <li><a href="form-validation-1.html">Form Validation</a></li>
                          <li><a href="base-input-1.html">Base Inputs</a></li>
                          <li><a href="radio-checkbox-control-1.html">Checkbox & Radio</a></li>
                          <li><a href="input-group-1.html">Input Groups</a></li>
                          <li><a href="megaoptions-1.html">Mega Options</a></li>
                        </ul>
                      </li>
                      <li><a class="submenu-title" href="#">Form Widgets<span class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                        <ul class="nav-sub-childmenu submenu-content">
                          <li><a href="datepicker-1.html">Datepicker</a></li>
                          <li><a href="time-picker-1.html">Timepicker</a></li>
                          <li><a href="datetimepicker-1.html">DateTimepicker</a></li>
                          <li><a href="daterangepicker-1.html">Daterangepicker</a></li>
                          <li><a href="touchspin-1.html">Touchspin</a></li>
                          <li><a href="select2-1.html">Select2</a></li>
                          <li><a href="switch-1.html">Switch</a></li>
                          <li><a href="typeahead-1.html">Typeahead</a></li>
                          <li><a href="clipboard-1.html">Clipboard</a></li>
                        </ul>
                      </li>
                      <li><a class="submenu-title" href="#">Form layout<span class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                        <ul class="nav-sub-childmenu submenu-content">
                          <li><a href="default-form-1.html">Default Forms</a></li>
                          <li><a href="form-wizard-1.html">Form Wizard 1</a></li>
                          <li><a href="form-wizard-two-1.html">Form Wizard 2</a></li>
                          <li><a href="form-wizard-three-1.html">Form Wizard 3</a></li>
                        </ul>
                      </li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a class="submenu-title" href="#">Bootstrap Tables<span class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                        <ul class="nav-sub-childmenu submenu-content">
                          <li><a href="bootstrap-basic-table-1.html">Basic Tables</a></li>
                          <li><a href="bootstrap-sizing-table-1.html">Sizing Tables</a></li>
                          <li><a href="bootstrap-border-table-1.html">Border Tables</a></li>
                          <li><a href="bootstrap-styling-table-1.html">Styling Tables</a></li>
                          <li><a href="table-components-1.html">Table components</a></li>
                        </ul>
                      </li>
                      <li><a class="submenu-title" href="#">Data Tables<span class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                        <ul class="nav-sub-childmenu submenu-content">
                          <li><a href="datatable-basic-init-1.html">Basic Init</a></li>
                          <li><a href="datatable-advance-1.html">Advance Init</a></li>
                          <li><a href="datatable-styling-1.html">Styling</a></li>
                          <li><a href="datatable-AJAX-1.html">AJAX</a></li>
                          <li><a href="datatable-server-side-1.html">Server Side</a></li>
                          <li><a href="datatable-plugin-1.html">Plug-in</a></li>
                          <li><a href="datatable-API-1.html">API</a></li>
                          <li><a href="datatable-data-source-1.html">Data Sources</a></li>
                        </ul>
                      </li>
                      <li><a class="submenu-title" href="#">Ex. Data Tables<span class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                        <ul class="nav-sub-childmenu submenu-content">
                          <li><a href="datatable-ext-autofill-1.html">Auto Fill</a></li>
                          <li><a href="datatable-ext-basic-button-1.html">Basic Button</a></li>
                          <li><a href="datatable-ext-col-reorder-1.html">Column Reorder</a></li>
                          <li><a href="datatable-ext-fixed-header-1.html">Fixed Header</a></li>
                          <li><a href="datatable-ext-html-5-data-export-1.html">HTML 5 Export</a></li>
                          <li><a href="datatable-ext-key-table-1.html">Key Table</a></li>
                          <li><a href="datatable-ext-responsive-1.html">Responsive</a></li>
                          <li><a href="datatable-ext-row-reorder-1.html">Row Reorder</a></li>
                          <li><a href="datatable-ext-scroller-1.html">Scroller</a></li>
                        </ul>
                      </li>
                      <li><a href="jsgrid-table-1.html">Js Grid Table        </a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="state-color-1.html">State color</a></li>
                      <li><a href="typography-1.html">Typography</a></li>
                      <li><a href="avatars-1.html">Avatars</a></li>
                      <li><a href="helper-classes-1.html">helper classes</a></li>
                      <li><a href="grid-1.html">Grid</a></li>
                      <li><a href="tag-pills-1.html">Tag & pills</a></li>
                      <li><a href="progress-bar-1.html">Progress</a></li>
                      <li><a href="modal-1.html">Modal</a></li>
                      <li><a href="alert-1.html">Alert</a></li>
                      <li><a href="popover-1.html">Popover</a></li>
                      <li><a href="tooltip-1.html">Tooltip</a></li>
                      <li><a href="toast-1.html">Toasts</a></li>
                      <li><a href="loader-1.html">Spinners</a></li>
                      <li><a href="dropdown-1.html">Dropdown</a></li>
                      <li><a href="according-1.html">Accordion</a></li>
                      <li><a class="submenu-title" href="#">Tabs<span class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                        <ul class="nav-sub-childmenu submenu-content">
                          <li><a href="tab-bootstrap-1.html">Bootstrap Tabs</a></li>
                          <li><a href="tab-material-1.html">Line Tabs</a></li>
                        </ul>
                      </li>
                      <li><a href="list-1.html">Lists</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="scrollable-1.html">Scrollable</a></li>
                      <li><a href="tree-1.html">Tree view</a></li>
                      <li><a href="bootstrap-notify-1.html">Bootstrap Notify</a></li>
                      <li><a href="rating-1.html">Rating</a></li>
                      <li><a href="dropzone-1.html">dropzone</a></li>
                      <li><a href="tour-1.html">Tour</a></li>
                      <li><a href="sweet-alert2-1.html">SweetAlert2</a></li>
                      <li><a href="modal-animated-1.html">Animated Modal</a></li>
                      <li><a href="owl-carousel-1.html">Owl Carousel</a></li>
                      <li><a href="ribbons-1.html">Ribbons</a></li>
                      <li><a href="pagination-1.html">Pagination</a></li>
                      <li><a href="breadcrumb-1.html">Breadcrumb</a></li>
                      <li><a href="steps-1.html">Steps</a></li>
                      <li><a href="range-slider-1.html">Range Slider</a></li>
                      <li><a href="image-cropper-1.html">Image cropper</a></li>
                      <li><a href="sticky-1.html">Sticky</a></li>
                      <li><a href="basic-card-1.html">Basic Card</a></li>
                      <li><a href="creative-card-1.html">Creative Card</a></li>
                      <li><a href="tabbed-card-1.html">Tabbed Card</a></li>
                      <li><a href="dragable-card-1.html">Draggable Card</a></li>
                      <li><a class="submenu-title" href="#">Timeline<span class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                        <ul class="nav-sub-childmenu submenu-content">
                          <li><a href="timeline-v-1-1.html">Timeline 1</a></li>
                          <li><a href="timeline-v-2-1.html">Timeline 2</a></li>
                        </ul>
                      </li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="form-builder-1-1.html"> Form Builder 1</a></li>
                      <li><a href="form-builder-2-1.html"> Form Builder 2</a></li>
                      <li><a href="pagebuild-1.html">Page Builder</a></li>
                      <li><a href="button-builder-1.html">Button Builder</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="animate-1.html">Animate</a></li>
                      <li><a href="scroll-reval-1.html">Scroll Reveal</a></li>
                      <li><a href="AOS-1.html">AOS animation</a></li>
                      <li><a href="tilt-1.html">Tilt Animation</a></li>
                      <li><a href="wow-1.html">Wow Animation</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="flag-icon-1.html">Flag icon</a></li>
                      <li><a href="font-awesome-1.html">Fontawesome Icon</a></li>
                      <li><a href="ico-icon-1.html">Ico Icon</a></li>
                      <li><a href="themify-icon-1.html">Thimify Icon</a></li>
                      <li><a href="feather-icon-1.html">Feather icon</a></li>
                      <li><a href="whether-icon-1.html">Whether Icon</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="buttons-1.html">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
                            <path d="M11.1437 17.8829H4.67114" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="chart-apex-1.html">Apex Chart</a></li>
                      <li><a href="chart-google-1.html">Google Chart</a></li>
                      <li><a href="chart-sparkline-1.html">Sparkline chart</a></li>
                      <li><a href="chart-flot-1.html">Flot Chart</a></li>
                      <li><a href="chart-knob-1.html">Knob Chart</a></li>
                      <li><a href="chart-morris-1.html">Morris Chart</a></li>
                      <li><a href="chartjs-1.html">Chatjs Chart</a></li>
                      <li><a href="chartist-1.html">Chartist Chart</a></li>
                      <li><a href="chart-peity-1.html">Peity Chart</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="landing-page-1.html">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
                            <path d="M8.54248 9.21777H15.3975" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="sample-page-1.html">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
                            <path d="M14.3053 15.45H8.90527" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="internationalization-1.html">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
                          ...
                          <div class="col mega-box">
                            <div class="link-section">
                              ...
                              <ul class="submenu-content opensubmegamenu">                      
                                <li><a href="error-page1-1.html" target="_blank">Error page 1</a></li>
                                <li><a href="error-page2-1.html" target="_blank">Error page 2</a></li>
                                <li><a href="error-page3-1.html" target="_blank">Error page 3</a></li>
                                <li><a href="error-page4-1.html" target="_blank">Error page 4</a></li>
                              </ul>
                            </div>
                          </div>
                          <div class="col mega-box">
                            <div class="link-section">
                              ...
                              <ul class="submenu-content opensubmegamenu">
                                <li><a href="login-1.html" target="_blank">Login Simple</a></li>
                                <li><a href="login_one-1.html" target="_blank">Login with bg image</a></li>
                                <li><a href="login_two-1.html" target="_blank">Login with image two                      </a></li>
                                <li><a href="login-bs-validation-1.html" target="_blank">Login With validation</a></li>
                                <li><a href="login-bs-tt-validation-1.html" target="_blank">Login with tooltip</a></li>
                                <li><a href="login-sa-validation-1.html" target="_blank">Login with sweetalert</a></li>
                                <li><a href="sign-up-1.html" target="_blank">Register Simple</a></li>
                                <li><a href="sign-up-one-1.html" target="_blank"> Register with Bg Image                              </a></li>
                                <li><a href="sign-up-two-1.html" target="_blank">Register with Bg video                          </a></li>
                                <li><a href="unlock-1.html">Unlock User</a></li>
                                <li><a href="forget-password-1.html">Forget Password</a></li>
                                <li><a href="creat-password-1.html">Creat Password</a></li>
                                <li><a href="maintenance-1.html">Maintenance</a></li>
                              </ul>
                            </div>
                          </div>
                          <div class="col mega-box">
                            <div class="link-section">
                              ...
                              <ul class="submenu-content opensubmegamenu">
                                <li><a href="comingsoon-1.html">Coming Simple</a></li>
                                <li><a href="comingsoon-bg-img-1.html">Coming with Bg Image</a></li>
                              </ul>
                            </div>
                          </div>
                          <div class="col mega-box">
                            <div class="link-section">
                              ...
                              <ul class="submenu-content opensubmegamenu">
                                <li><a href="basic-template-1.html">Basic Email</a></li>
                                <li><a href="email-header-1.html">Basic With Header                       </a></li>
                                <li><a href="template-email-2-1.html">Email Template 2</a></li>
                                <li><a href="ecommerce-templates-1.html">Ecommerce Email</a></li>
                                <li><a href="email-order-success-1.html">Order Success          </a></li>
                              </ul>
                            </div>
                          </div>
                        </div>
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="gallery-1.html">Gallery Grid</a></li>
                      <li><a href="gallery-with-description-1.html">Gallery Grid Desc</a></li>
                      <li><a href="gallery-masonry-1.html">Masonry Gallery</a></li>
                      <li><a href="masonry-gallery-with-disc-1.html">Masonry with Desc</a></li>
                      <li><a href="gallery-hover-1.html">Hover Effects</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="blog-1.html">Blog Details</a></li>
                      <li><a href="blog-single-1.html">Blog Single</a></li>
                      <li><a href="add-post-1.html">Add Post</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="faq-1.html">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="job-cards-view-1.html">Cards view</a></li>
                      <li><a href="job-list-view-1.html">List View</a></li>
                      <li><a href="job-details-1.html">Job Details</a></li>
                      <li><a href="job-apply-1.html">Apply</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="learning-list-view-1.html">Learning List</a></li>
                      <li><a href="learning-detailed-1.html">Detailed Course</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="map-js-1.html">Maps JS</a></li>
                      <li><a href="vector-map-1.html">Vector Maps</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="summernote-1.html">Summer Note</a></li>
                      <li><a href="ckeditor-1.html">CK editor</a></li>
                      <li><a href="simple-MDE-1.html">MDE editor</a></li>
                      <li><a href="ace-code-editor-1.html">ACE code editor </a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="knowledgebase-1.html">Knowledgebase</a></li>
                      <li><a href="knowledge-category-1.html">Knowledge category</a></li>
                      <li><a href="knowledge-detail-1.html">Knowledge detail</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="support-ticket-1.html">
                      <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g>
                ...
                <div class="sidebar-img-section">
                  <div class="sidebar-img-content"><img class="img-fluid" src="assets/images/side-bar-1.png" alt="">
          ...
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                ...
                <div class="col-12 col-sm-6">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index-1.html">                                       <i data-feather="home"></i></a></li>
                      ...
                      <form>
                        <div class="row mb-2">
                          <div class="profile-title">
                            <div class="media">                        <img class="img-70 rounded-circle" alt="" src="assets/images/user/7-1.jpg">
                              <div class="media-body">
    ...
    <!-- latest jquery-->
    <script src="assets/js/jquery-3.5.1.min-1.js"></script>
    <!-- Bootstrap js-->
    <script src="assets/js/bootstrap/bootstrap.bundle.min-1.js"></script>
    <!-- feather icon js-->
    <script src="assets/js/icons/feather-icon/feather.min-1.js"></script>
    <script src="assets/js/icons/feather-icon/feather-icon-1.js"></script>
    <!-- scrollbar js-->
    <script src="assets/js/scrollbar/simplebar-1.js"></script>
    <script src="assets/js/scrollbar/custom-1.js"></script>
    <!-- Sidebar jquery-->
    ...
    <script src="assets/js/theme-customizer/customizer-1.js"></script>
    <!-- login js-->
    <!-- Plugin used-->
  </body>
</html>