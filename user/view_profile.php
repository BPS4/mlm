    ...
    // UPDATE PERSONAL
        if (isset($_POST['submit_personal'])) {
            ...
            if (!$error) {
                ...
                $address_update = "`address`='$address',`city`='$city',`landmark`='$landmark', `state`='$state_name',`pin_code`='$pin_code', ";
                                        ...
                                        <div class="col-sm-12 col-xl-12 xl-100">
                                            <div class="card">
                                                <div class="card-header pb-0">
                                                    <h5>User Profile </h5>
                                                    <hr>
                                                    <h5 class="card-title mb-1 text-bold"><?php echo $header_text." - ".$kyc_status; ?></h5>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row mb-3">
                                                                    ...
                                                                    <form method="POST" action="" id="form_upload_record_personal" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="row align-items-center">
                                                                            ...
                                                                            <div class="mb-3 col-md-12">
                                                                                ...
                                                                                <input type="text" class="form-control" id="landmark" name="landmark" placeholder="Landmark" required value="<?php echo $landmark;?>" <?php echo $personal_readonly; ?>>
                                                                            </div>
                                                                        ...
                                                                        <div class="row g-2">
                                                                            ...
                                                                            <?php
                                                                                if ($pan_needed == 1) {
                                                                                    ?>
                                                                                        <div class="mb-3 col-xl-6 col-md-6">
                                                                                            <label for="file_pan" class="form-label">Upload PAN <span class="text-danger">*jpg/jpeg/png format; 150KB max</span></label>
                                                                                            <input type="file" name="file_pan" id="file_pan" class="form-control"  max-size="153600" accept="image/*" required onchange="if(admin_access==0) {check_image_size_before_upload(this.id,150);}">
                                                                                        </div>
                                                                            ...
                                                                            <?php
                                                                                if ($aadhaar_needed == 1) {
                                                                                    ?>
                                                                                        <div class="mb-3 col-xl-6">
                                                                                            <label for="file_aadhaar_front" class="form-label">Aadhaar Front<span class="text-danger">*jpg/jpeg/png format; 150KB max</span></label>
                                                                                            <input type="file" name="file_aadhaar_front"  max-size="153600" id="file_aadhaar_front" class="form-control" accept="image/*" required onchange="if(admin_access==0) {check_image_size_before_upload(this.id,150);}">
                                                                                        </div>
                                                                                        <div class="mb-3 col-xl-6">
                                                                                            <label for="file_aadhaar_back" class="form-label">Aadhaar Back<span class="text-danger">*jpg/jpeg/png format; 150KB max</span></label>
                                                                                            <input type="file" name="file_aadhaar_back"  max-size="153600" id="file_aadhaar_back" class="form-control" accept="image/*" required onchange="if(admin_access==0) {check_image_size_before_upload(this.id,150);}">
                                                                                        </div>
                                                                                    <?php
                                                                                } else {
                                                                                    ?>
                                                                                ...
                                                                                if ($bank_needed == 1) {
                                                                                    ?>
                                                                                        <div class="mb-3 col-xl-6 col-md-8">
                                                                                            <label for="file_bank_proof" class="form-label">Proof Photo <span class="text-danger">*jpg/jpeg/png format; 150KB max</span></label>
                                                                                            <input type="file" name="file_bank"  max-size="153600" id="file_bank_proof" class="form-control" accept="image/*" required onchange="if(admin_access==0) {check_image_size_before_upload(this.id,150);}">
                                                                                        </div>
                                                                                    <?php
                                                                                } else {
                                                                                    ?>
                                                                                 ...
                                                                                 if ($photo_needed == 1) {
                                                                                    ?>
                                                                                        <div class="mb-3 col-md-12 text-center">
                                                                                            <label for="file" class="form-label" style="float:left;">Upload Photo <span class="text-danger">* (Upload Your Realtime Photo) 10MB Max</span></label>
                                                                                            <!-- <input type="file" name="file" id="file_photo" class="form-control" accept="image/*" capture required onchange="loadImageFile(this.id)"> -->
                                                                                            <input type="file" name="file"  id="file_photo" class="form-control" accept="image/*"  max-size="2048000" capture="camera" onchange="loadImageFile(this.id)" required>
                                                                                    ...
                                                                                    ?>
                                                                                        <div class="mb-3 col-md-12 text-center">
                                                                                            ...
                                                                                            <?php
                                                                                            if(isset($_SESSION['user_doc_message']) && !$photo) {
                                                                                                echo '<script>alert("KYC & Profile photo required.")</script>'; 
                                                                                            }
                                                                                            ?>
                                                                                            <!-- <input type="text" class="form-control bg-label-success show-pointer" data-bs-toggle='modal' data-bs-target='#ModalShowPhoto' data-src="<?php echo $pan_doc; ?>" data-from="kyc" value="View Now" disabled> -->
                                                                                        </div>
                                                            ...
                                                            <div class="row g-2">
                                                                ...
                                                                <?php
                                                                    if ($bank_needed == 1) {
                                                                        ...
                                                                        ?>
                                                                            <div class="mb-3 col-xl-6 col-md-8">
                                                                                <label for="file_bank_proof" class="form-label">Uploaded #</label>
                                                                                <!-- <span class='mt-2 badge bg-label-info show-pointer' > -->
